    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admission_wt', models.DecimalField(decimal_places=1, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_wt', models.DecimalField(decimal_places=1, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_recipient', to='weighttrackingapi.employee')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_sender', to='weighttrackingapi.employee')),
            ],
        ),
    ]
